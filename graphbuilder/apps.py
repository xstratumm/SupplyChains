    ...
    def ready(self):
        if not SupplyNode.nodes.all():
            ...
            init_nodes = [
                ...
                { "id": "1", "neededRes": [res_dict(1,2),res_dict(2,1),], "giveRes": [res_dict(6,2),res_dict(3,5),]},
                ...
                { "id": "7", "neededRes": [res_dict(3,1),res_dict(6,5),res_dict(4,2),], "giveRes": [res_dict(3,4),]},
                { "id": "8", "neededRes": [res_dict(5,1),], "giveRes": [res_dict(4,4),]},
                { "id": "9", "neededRes": [res_dict(4,8),], "giveRes": [res_dict(6,3),]},
