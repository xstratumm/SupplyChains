...
// nodes = [{"id": "0", "neededRes": [], "giveRes": [{"name": "water", "quantity": 9}, {"name": "stone", "quantity": 3}, {"name": "fire", "quantity": 4}, {"name": "iron", "quantity": 8}], "entryPoint": true}, {"id": "1", "neededRes": [{"name": "water", "quantity": 2}, {"name": "stone", "quantity": 1}], "giveRes": [{"name": "buttplug", "quantity": 2}, {"name": "iron", "quantity": 1}]}, {"id": "2", "neededRes": [{"name": "fire", "quantity": 3}, {"name": "iron", "quantity": 4}], "giveRes": [{"name": "shit", "quantity": 2}, {"name": "stone", "quantity": 3}, {"name": "water", "quantity": 6}]}, {"id": "3", "neededRes": [{"name": "iron", "quantity": 1}], "giveRes": [{"name": "buttplug", "quantity": 5}]}, {"id": "4", "neededRes": [{"name": "buttplug", "quantity": 3}], "giveRes": [{"name": "fire", "quantity": 2}]}, {"id": "5", "neededRes": [{"name": "stone", "quantity": 2}, {"name": "shit", "quantity": 1}], "giveRes": [{"name": "water", "quantity": 1}, {"name": "shit", "quantity": 10}]}, {"id": "6", "neededRes": [{"name": "shit", "quantity": 3}, {"name": "water", "quantity": 2}], "giveRes": [{"name": "iron", "quantity": 7}]}, {"id": "7", "neededRes": [{"name": "iron", "quantity": 1}, {"name": "buttplug", "quantity": 5}, {"name": "shit", "quantity": 2}], "giveRes": [{"name": "iron", "quantity": 3}]}, {"id": "8", "neededRes": [{"name": "fire", "quantity": 5}], "giveRes": [{"name": "shit", "quantity": 4}, {"name": "iron", "quantity": 6}]}, {"id": "9", "neededRes": [{"name": "shit", "quantity": 9}, {"name": "water", "quantity": 5}], "giveRes": [{"name": "buttplug", "quantity": 3}]}, {"id": "10", "neededRes": [{"name": "iron", "quantity": 4}, {"name": "shit", "quantity": 2}, {"name": "buttplug", "quantity": 1}], "giveRes": [], "exitPoint": true}]
...
// оптимизация графа
let optimizedGraph = apiRequest("POST", "api/optimizegraph", graph);
// drawGraph(optimizedGraph);

// console.log(apiRequest("POST", "api/estimategraph", optimizedGraph));
// apiRequest("POST", "api/savegraph", optimizedGraph);